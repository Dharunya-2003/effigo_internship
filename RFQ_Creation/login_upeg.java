...
public class login_upeg 
{
    ...
    public void login() throws InterruptedException {
        ...
        // basic information
        driver.findElement(By.xpath("//input[@id='tenderTitle']")).sendKeys("Procurement of IT Equipment02");
      ...
      // Switch to alert and accept it
        ...
        driver.findElement(By.xpath("//input[@name=\"endBidSubmissionDate\"]")).sendKeys("10-04-2025 14:44:00");
